...
namespace LitLounge.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public string ProfileImagePath { get; private set; } /* Added */
        ...
        public class InputModel
        {
            ...
            [Display(Name = "Ingen profilbild än")] 
            public IFormFile ProfileImage { get; set; } /* Added */
        }

        private async Task LoadAsync(LitLoungeUser user)
        {
            var userName = await _userManager.GetUserNameAsync(user);
            var phoneNumber = await _userManager.GetPhoneNumberAsync(user);

            Username = userName;
            ProfileImagePath = user.ProfileImagePath; /* Added */
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.ProfileImage != null) /*Added, hela if-satsen*/
            {
        ...
        public async Task<IActionResult> OnPostDeleteImageAsync() /*Added, hela if-satsen*/
        {
            var user = await _userManager.GetUserAsync(User);
            if (user == null)
            {
